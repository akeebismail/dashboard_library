        ...
        <div class="col-lg-8 col-md-12">
            <div class="card">
                <div class="card-block">
                    ...
                    <form class="m-t-40" novalidate method="post" action="{{route('admin.update',$admin->id)}}">
                        ...
                        <div class="form-group">
                            <div class="controls {{ $errors->has('first_name')? 'has-danger' : 'has-success' }}">
                                ...
                                <input type="text" name="first_name" value="{{dd($room->first_name)}}" class="form-control" required data-validation-required-message="The first name is required">
                            </div>
                        </div>
                        <div class="form-group">
